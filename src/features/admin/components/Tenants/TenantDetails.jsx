...
import {getUsersByTenantId} from "../../api/userEndpoints.js";
...
const TenantDetails = () => {
    ...
    const loadEverything = async () => {
        ...
        try {
            const [tenantRes, officesRes, usersRes] = await Promise.allSettled([
            ...
            if (tenantRes.status === 'fulfilled') {
                ...
                setError("Error en la carga del Tenant");
            }

            if (officesRes.status === 'fulfilled') {
                setOffices(officesRes.value);
            } else {
    ...
    return (
        loadingEverything ? (
            <div className="text-center my-5">
                ...
                <p className="mt-2">Cargando datos del Tenant, Consultorios y Administradores...</p>
            </div>
        ) : (
            <>
                ...
                <div className="row">
                    ...
                    {tenantLoading && offices && offices.length > 0 && (
                        <div className="text-center my-5">
                            <div className="spinner-grow text-success" role="status">
                                <span className="visually-hidden">Cargando...</span>
                            </div>
                                    ...
                                    <div className="card project-boxed d-flex flex-column">
                                        ...
                                        <div className="card-header align-items-start">
                                            <div>
                                                ...
                                                <div className="text-dark fs-14 text-nowrap"><i
                                                    className="fas fa-calendar me-3"></i>Creado
                                        ...
                                        <div className="card-body p-0 pb-3">
                                            <ul className="list-group list-group-flush">
                                                ...
                                                <li className="list-group-item">
                                                    ...
                                                    <span
                                                        className="text-black desc-text ms-2">{office.managerName}</span>
                                                </li>
                                                <div
                                                    className="card-body d-flex justify-content-center align-items-center pb-3">
                                                    <Button
                                                        variant={`${office.active ? 'success' : 'danger'} btn-rounded`}>
                                       <span
                                    ...
                                    <form>
                                                ...
                                                <div className="row">
                                                    <div className="image-placeholder">
                                                        ...
                                                        <div className="avatar-preview">
                                                            <div id="imagePreview">
                                                                <img id="saveImageFile"
                                                                     src={file ? URL.createObjectURL(file) : users}
                                                    ...
                                                    <div className="col-xl-6">
                                                        <div className="form-group">
                                                            <label className="text-label">Nombre del
                                                                Consultorio <span
                                                    ...
                                                    <div className="col-xl-6">
                                                        <div className="form-group">
                                                            <label className="text-label">Teléfono
                                                                Administrador <span
                                                                    className="required">*</span></label>
                                                            <input
                                                                type="number"
                                                    ...
                                                    <div className="col-xl-6">
                                                        <div className="form-group mb-3">
                                                            <label className="text-label">Plan Actual <span
                                                                className="required">*</span></label>
                                                            <Select
                                                                name="currentPlan"
                                                                options={planOptions}
                                                    ...
                                                    <div className="col-xl-12">
                                                        <div className="form-group">
                                                            <label htmlFor="message-text"
                                                                   className="col-form-label">Categorias: </label>
                                        ...
                                        <div className="modal-footer">
                                            <button type="submit" className="btn btn-primary"
                                                    onClick={handleSubmitSaveOffice}>Crear
                                                Consultorio
                                            </button>
